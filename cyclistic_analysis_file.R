...
# Load the data that is saved in the local folder
aug_2021 <- read.csv("C:/202108-divvy-tripdata.csv")
sep_2021 <- read.csv("C:/202109-divvy-tripdata.csv")
oct_2021 <- read.csv("C:/202110-divvy-tripdata.csv")
nov_2021 <- read.csv("C:/202111-divvy-tripdata.csv")
dec_2021 <- read.csv("C:/202112-divvy-tripdata.csv")
jan_2022 <- read.csv("C:/202201-divvy-tripdata.csv")
feb_2022 <- read.csv("C:/202202-divvy-tripdata.csv")
mar_2022 <- read.csv("C:/202203-divvy-tripdata.csv")
apr_2022 <- read.csv("C:/202204-divvy-tripdata.csv")
may_2022 <- read.csv("C:/202205-divvy-tripdata.csv")
jun_2022 <- read.csv("C:/202206-divvy-tripdata.csv")
jul_2022 <- read.csv("C:/202207-divvy-tripdata.csv")

# compare the Data frames of all the loaded files are same or not
...
# Bind or Append all the tbales data into one table i.e., Cyclistic
...
# Now summarize the new Data set
summary(cyclistic)

# View the cyclistic Data set
View(cyclistic)
